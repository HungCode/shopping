...
@NamedQueries({
    ...
    @NamedQuery(name = "Shoe.findByProductId", query = "SELECT s FROM Shoe s WHERE s.productId = :productId"),
...
public class Shoe implements Serializable {
    ...
    public Shoe(Integer productId) {
        this.productId = productId;
    }

    public Shoe(Integer productId, int id) {
        this.productId = productId;
        this.id = id;
    }
    ...
    public String toString() {
        return "entity.Shoe[ productId=" + productId + " ]";
    }
