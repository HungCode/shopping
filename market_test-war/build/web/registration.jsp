<%-- 
    ...
    Created on : Apr 23, 2019, 8:31:34 AM
    Author     : LF
--%>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="login_form_inner reg_form">
                            ...
                            <form class="row login_form" action="Registry" method="POST" id="contactForm" novalidate="novalidate">
                                ...
                                <div class="col-md-12 form-group">
                                    <input type="text" class="form-control" id="name" name="gender" placeholder="Gender">
                                </div>
                                
                                <div class="col-md-12 form-group">
                                    <input type="date" class="form-control" id="name" name="birthday" placeholder="Birthday">
                                </div>
                                <div class="col-md-12 form-group">
                                    <input type="email" class="form-control" id="email" name="username" placeholder="Username">
                                </div>
                                <div class="col-md-12 form-group">
